...
<html>
    ...
    <body>
        ...
        <center>
            <h2>Enter the category information to add it to the category list for additional items to be added to the category to sell a new type of products!</h2>
        </center>
        </br>
        <form action="./seller_backend/seller_addcategory_verification.php" method="post">
